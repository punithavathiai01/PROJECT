...
insert into fc_user_login values(103,'bhava','123456','654321',13);
insert into fc_user_login values(104,'sri','123457','754321',14);
...
alter table fc_user_login rename column UserName to User_Name;
...
select * from fc_user_reg f2 left join fc_user_login f3 on f2.User_Name right join fc_user_order f1 on f2.User_Name;

select * from fc_user_reg f2 left join fc_user_login f3 on f2.user_ID right join fc_user_order f1 on f2.user_ID;

select * from fc_user_reg f2 right join fc_user_login f3 on f2.User_Name left join fc_user_order f1 on f2.User_Name;

select * from fc_user_reg f2 left join fc_user_login f3 on f2. user_Name left join fc_user_order f1 on f2. user_Name;

select * from fc_user_reg f1 , fc_user_order f3 , fc_user_login;
select * from fc_user_reg f1 , fc_user_order f3;

select * from fc_user_reg f1 left join fc_user_login f2 on f1.User_ID=f2

select * from  User_ID (U)
From fc_user_reg 
inner join fc_user_login
on fc_user_reg. User_ID=fc_user_login. User_ID;
